...
namespace Rapid_Reporter
{
    ...
    public partial class SMWidget : Window
    {
        ...
        TwitterAddon m_twitter = new TwitterAddon();
        bool m_flickrLoggedIn = false;
        bool m_twitterLoggedIn = false;
        ...
        public static bool ToggleUploadFlickr = false;
        public static bool ToggleUploadTwitter = false;
        ...
        public void CharCounter()
        {
            ...
            preLength = currentSession.tester.Length + currentSession.charter.Length + currentSession.noteTypes[currentNoteType].Length + FlickrAddon.hashcode.Length;
        ...
        private void ChangeAccount_Click(object sender, RoutedEventArgs e) // #ADDED CODE#________________---------------CHANGE ACCOUNT---------------------_________________________
        {
        	...
        	{
        		m_flickr.LogOut();
        		FlickrInlogg.Text = "FlickrAccount: offline TwitterAccount: offline";
        	}
        	else
        	{
        		m_flickr.Login();
        ...
        //-------------------------------------------_________________________________________________________________________________________________________________________________
        private void ToggleUpload_ClickFlickr(object sender, RoutedEventArgs e) // #ADDED CODE#________________---------------TOGGLE UPLOAD---------------------____________________________
        {
            Logger.record("[ToggleUpload_Click]: ToggleUpload", "SMWidget", "info");
            SMWidget.ToggleUploadFlickr = !SMWidget.ToggleUploadFlickr;
       //     bool edit = false;
      ...
      //      if (edit) this.WindowState = System.Windows.WindowState.Minimized;          // <--\
        ...
        private void ToggleUpload_ClickTwitter(object sender, RoutedEventArgs e) // #ADDED CODE#________________---------------TOGGLE UPLOAD---------------------____________________________
        {
            Logger.record("[ToggleUpload_ClickTwitter]: ToggleUploadTwitter", "SMWidget", "info");
            SMWidget.ToggleUploadTwitter = !SMWidget.ToggleUploadTwitter;
            
       //     bool edit = false;
       //     if (System.Windows.Forms.Control.ModifierKeys == System.Windows.Forms.Keys.Shift) edit = true;
      //      if (edit) this.WindowState = System.Windows.WindowState.Minimized;          // <--\

            if (SMWidget.ToggleUploadTwitter == true)
            {
				TwitterInlogg.Text = "TwitterAccount: " + TwitterAddon.ScreenName;
                IcontwitIcon.Source = new BitmapImage(new Uri("icontwit.png", UriKind.Relative));
                CharCounter();
            ...
            {
            	TwitterInlogg.Text = "TwitterAccount: Not posting";
                IcontwitIcon.Source = new BitmapImage(new Uri("icontwit_dis.png", UriKind.Relative));
                charCounter.Text = "";
            }
        ...
        private void ScreenShotIcon_ImageFailed(object sender, ExceptionRoutedEventArgs e)
        {
